...
they wcould be both minor and major), so, to control for this, I chose simply 
deaths. In this analysis, I only looked at extreme weather events since the 
start of 2000, as those event were the most consistently catalogued. What I 
found is that the most destructive events, in descending order, are as follows:
...
starting at the year 2000. The justification for this, to reiterate from the Synopsis, is that the earlier documented events in history were not catalogued well and as a result cannot be trusted. The following code accomplishes this:
...
Crop Damage and the Property Damage columns by their multipliers (again, please see the Synopsis for justification):
